// Custom logo
window.portalOptions.logo = '<img height="44" width="180" alt="Developer Portal Demo" src="https://dinw9xheo7f2n.cloudfront.net/tibco-mashery.jpg">';

var masheryPortalThemeSelected = sessionStorage.getItem('masheryPortalTheme');
if (masheryPortalThemeSelected === 'toggle-theme-default') {
...
} else if (masheryPortalThemeSelected === 'toggle-theme-skinny-nav') {
	// Remove the user nav
	...
	window.portalOptions.templates.primaryNav = function () {
		var template =
			'<div class="nav-primary nav-wrap" id="nav-primary">' +
				'<div class="container padding-top-small padding-bottom-small">' +
					'<a id="logo" class="logo" href="/">{{content.logo}}</a>' +
